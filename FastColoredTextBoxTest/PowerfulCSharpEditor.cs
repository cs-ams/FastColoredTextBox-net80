...
namespace FastColoredTextBoxTest
{
    public partial class PowerfulCSharpEditor : Form
    {
        ...
        public PowerfulCSharpEditor()
        {
            ...
            copyToolStripMenuItem.Image = resources.GetObject("copyToolStripButton.Image") as Image;
            cutToolStripMenuItem.Image = resources.GetObject("cutToolStripButton.Image") as Image;
            pasteToolStripMenuItem.Image = resources.GetObject("pasteToolStripButton.Image") as Image;
        }
                ...
                if (e.ColumnIndex == 1)
                    ...
                    switch (item.type)
                    {
                        case ExplorerItemType.Class:
                            e.Value = FastColoredTextBoxTest.Properties.Resources.class_libraries;
                            return;
                        case ExplorerItemType.Method:
                            e.Value = FastColoredTextBoxTest.Properties.Resources.box;
                            return;
                        case ExplorerItemType.Event:
                            e.Value = FastColoredTextBoxTest.Properties.Resources.lightning;
                            return;
                        case ExplorerItemType.Property:
                            e.Value = FastColoredTextBoxTest.Properties.Resources.property;
                            return;
                    }
            }
            catch{;}
